...
const LegacyBox = React.forwardRef<HTMLDivElement, BoxDocProps>(
  (
    {
      animation,
      background,
...
type LegacyBoxComponent<C extends React.ElementType = 'div'> = <T extends React.ElementType = C>(
  props: BoxProps<T>,
) => JSX.Element;

export { LegacyBox };
export type { LegacyBoxComponent, BoxProps, TransientBoxProps };
