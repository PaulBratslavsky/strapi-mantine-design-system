...
const LegacyTypography = forwardRef(
...
) as LegacyTypographyComponent;

type LegacyTypographyComponent<C extends React.ElementType = 'span'> = <T extends React.ElementType = C>(
...
export type { TypographyProps, LegacyTypographyComponent, TransientTypographyProps };
