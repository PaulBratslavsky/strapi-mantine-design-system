...
const LegacyFlex = forwardRef(<C extends React.ElementType = 'div'>(props: FlexProps<C>, ref: PolymorphicRef<C>) => {
...
type LegacyFlexComponent<C extends React.ElementType = 'div'> = typeof LegacyFlex<C>;
...
export { LegacyFlex };
export type { LegacyFlexComponent, FlexProps, TransientFlexProps };
